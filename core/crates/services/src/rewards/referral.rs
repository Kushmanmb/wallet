...
use storage::{ConfigRepository, DatabaseClient, DatabaseError, ReferralRecord, RewardsRepository, WalletsRepository};
...
pub fn use_or_verify_referral(client: &mut DatabaseClient, referrer_username: &str, referrer_status: RewardStatus, wallet_id: i32, device_id: i32, risk_signal_id: Option<i32>) -> Result<Vec<RewardEvent>, Box<dyn Error + Send + Sync>> {
