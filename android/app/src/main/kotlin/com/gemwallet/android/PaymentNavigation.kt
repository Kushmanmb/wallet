...
class PaymentNavigation @Inject constructor(private val getWalletAssets: GetWalletAssets, private val paymentService: GemPaymentServiceInterface, private val assetsService: GemAssetsServiceInterface) {
